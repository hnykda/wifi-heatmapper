  ...
  return (
    <div>
      ...
      <input
        ...
        onChange={(e) => updateSettings({ floorplanImagePath: e.target.value })}
      />
      <br />
      ...
      <input
        ...
        onChange={(e) => updateSettings({ iperfServerAdrs: e.target.value })}
      />
      <br />
      ...
      <input
        ...
        onChange={(e) => updateSettings({ sudoerPassword: e.target.value })}
      />
